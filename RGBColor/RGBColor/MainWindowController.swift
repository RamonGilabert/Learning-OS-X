...
class MainWindowController: NSWindowController {
    ...
    override func windowDidLoad() {
        ...
        let greenLabel = NSTextField(frame: NSMakeRect(self.greenSlider.frame.origin.x - 15, self.greenSlider.frame.origin.y + 8, 18, 18))
        ...
        let blueLabel = NSTextField(frame: NSMakeRect(self.blueSlider.frame.origin.x - 15, self.blueSlider.frame.origin.y + 8, 18, 18))
